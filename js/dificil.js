...
$(document).ready(function() {
    ...
    $('.drop').droppable({
        accept: '.drag',
        drop: function() {
            // alert('Traje correcto, es de la isla de Tenerife')
    ...
    $('.drop4').droppable({
        ...
        drop: function() {
            ...
            $(this).css('background', 'green')
            toastr.success('Traje correcto, de la isla de La Palma')
        }
    })
    ...
    $('.drop5').droppable({
        accept: '.drag5',
        drop: function() {
            // alert('Traje correcto, es de la isla de Lanzarote')
            $(this).css('background', 'green')
            toastr.success('Traje correcto, es de la isla de Lanzarote')
        }
    })
})